...
public class MilvusVectorStoreAutoConfiguration {
    ...
    PropertiesMilvusServiceClientConnectionDetails customMilvusServiceClientConnectionDetails(
    ...
    public MilvusVectorStore dashscopeMilvusVectorStore(MilvusServiceClient milvusClient, @Qualifier("dashscopeEmbeddingModel") EmbeddingModel embeddingModel,
    ...
    public MilvusServiceClient milvusClient(MilvusVectorStoreProperties serverProperties,
                                            MilvusServiceClientProperties clientProperties, MilvusServiceClientConnectionDetails customMilvusServiceClientConnectionDetails) {

        var builder = ConnectParam.newBuilder()
                .withHost(customMilvusServiceClientConnectionDetails.getHost())
                .withPort(customMilvusServiceClientConnectionDetails.getPort())
    ...
    @Bean
    public VectorStoreService dashscopeMilvusVectorStoreService(@Qualifier("dashscopeMilvusVectorStore") MilvusVectorStore dashscopeMilvusVectorStore) {
        return new MilvusVectorStoreServiceImpl(dashscopeMilvusVectorStore, PlatformEnum.ALI_BAI_LIAN);
    }
