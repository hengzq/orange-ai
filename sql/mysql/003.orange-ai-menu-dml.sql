...
values (100300, @t_id, 1011, '新增', 'orange-ai:model:add', 1, 1, @u_id),
       (100301, @t_id, 1011, '删除', 'orange-ai:model:delete', 1, 10, @u_id),
       (100302, @t_id, 1011, '修改', 'orange-ai:model:update', 1, 20, @u_id)
;
