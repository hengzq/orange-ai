...
public class ChatController {
    ...
    @Operation(summary = "终止对话", operationId = "orange-ai:session:update")
    @PostMapping("/{sessionId}/stop")
    public Result<Boolean> stopBySessionId(@PathVariable("sessionId") String sessionId) {
        return ResultWrapper.ok(chatService.stopBySessionId(sessionId));
    }
