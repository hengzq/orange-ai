...
import cn.hengzq.orange.ai.common.biz.app.vo.param.AppConversationStreamParam;
import cn.hengzq.orange.ai.common.biz.app.vo.param.AppPageParam;
...
//    public Result<AppDetailVO> getLatestById(@Parameter(description = "ID") @PathVariable("appId") String appId,
//                                             @Parameter(description = "是否获取最新发布版本 true:最新发布版, false:最新快照版,如果没有快照版，返回最新稳定版本）") @RequestParam(required = false) boolean latestReleased) {
//        return ResultWrapper.ok(appService.getLatestByAppId(appId, latestReleased));
//    }


    @Operation(summary = "分页查询", operationId = "orange-ai:app:page")
    @PostMapping(value = "/page")
    public Result<PageDTO<AppVO>> page(@RequestBody AppPageParam param) {
